...
public class UserController {
    ...
    public ResponseEntity<UserCreateResponse> createNewUser(@RequestBody @Validated UserCreateRequest request){
    ...
    public ResponseEntity<UserSearchResponse> searchUsers(
        ...
        List<UserCreateResponse> content = userMapper.toUserCreateResponse(users.getContent());
